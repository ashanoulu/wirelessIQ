...
from wirelessIQ.StrDef import StrDef
from wirelessIQ.timer_wp import timer
import numpy as np
...
class SensorDataCollection:
    ...
    def periodical_stats(self):
        ...
        print("et_start, et_temp, et_humidity, et_pressure, et_air_quality, et_light, et_window_status, et_light_status, et_end")
        print(et_start, et_temp, et_humidity, et_pressure, et_air_quality, et_light, et_window_status, et_light_status, sapi.get_timestamp())
...
# Q: Lux measures illuminance, luminosity same thing?
# Q: Light on off?  Natural light vs artificial light
